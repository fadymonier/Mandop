...
class __$$LoggedOutImplCopyWithImpl<T, $Res>
    extends _$LoginStateCopyWithImpl<T, $Res, _$LoggedOutImpl<T>>
...
class _$LoggedOutImpl<T> implements LoggedOut<T> {
  ...
  @override
  String toString() {
    return 'LoginState<$T>.loggedOut()';
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$LoggedOutImpl<T>);
  }
...
abstract class LoggedOut<T> implements LoginState<T> {
  const factory LoggedOut() = _$LoggedOutImpl<T>;
}
